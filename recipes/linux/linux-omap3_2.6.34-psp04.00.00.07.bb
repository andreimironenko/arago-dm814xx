...
SRC_URI += "http://bangsdowebsvr01.india.ti.com:8060/SysLink/${SYSLINKPV}${SYSLINKPVextra}/REL_SYSLINK_${SYSLINKPVwithdots}/syslink_${SYSLINKPV}${SYSLINKPVextra}.tar.gz;name=syslinktarball \
            file://defconfig.vpss \
"
