...
SRC_URI_append_omap3 = "http://install.source.dir.local/TI-Neon-BlitEngine-Qte-Arago-v1.4.patch;name=neonpatch \
		http://install.source.dir.local/TI-Neon-BlitEngine-Qte-v1.4.tar.gz;name=neontarball"
