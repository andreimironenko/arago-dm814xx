...
setenv bootargs 'console=ttyO2,115200n8 rootwait root=/dev/mmcblk0p2 rw mem=364M@0x80000000 mem=324M@0x9F900000 notifyk.vpssm3_sva=0xBF900000 ip=off noinitrd'
