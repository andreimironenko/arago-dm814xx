...
HTTP_PATH="exports/${BUILD_PURPOSE}/${PRODUCT}.${PRODUCT_RELEASE}-${PRODUCT_VERSION}/${RELDIR}/${MACHINE}"
FTP_PATH="${BUILD_PURPOSE}/${PRODUCT}.${PRODUCT_RELEASE}-${PRODUCT_VERSION}/${RELDIR}/${MACHINE}"
TFTP_PATH="${FTP_PATH}/img"
NFS_PATH="${EXPORT_PATH}/nfs"
...
declare COMMAND_LINE="MACHINE=$MACHINE PRODUCT=$PRODUCT \
    ...
    EXPORT_PATH=$EXPORT_PATH HTTP_PATH=$HTTP_PATH FTP_PATH=$FTP_PATH \
    TFTP_PATH=$TFTP_PATH NFS_PATH=$NFS_PATH \
    GITSERVER=$GITSERVER FTPSERVER=$FTPSERVER TFTPSERVER=$TFTPSERVER \
    HTTPSERVER=$HTTPSERVER NFSERVER=$NFSSERVER \
    bitbake"
